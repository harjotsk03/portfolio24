...
export const Hero = () => {
  ...
  return (
    <div className="z-20 w-full overflow-x-hidden h-screen pb-10 px-14 relative flex flex-col items-center justify-center">
      <h1 className="text-white text-[11vw] poppins-semibold">Harjot Singh</h1>
      <p className="poppins-light text-green-100-custom text-lg">
        A student and aspiring software engineer with a focus on user experience
      </p>
      <p className="poppins-light text-green-200-custom text-lg mt-2">
        BSc. Computing Science & Interactive Technology
      </p>
      <div className="flex flex-col items-center w-full mr-2 mt-16">
        <div className="">
          <div className="">
